...
python $script casp_study=$casp_study processes=$processes forward_expansion=${forward_expansions[0]} retro_expansion=${retro_expansions[0]}
python $script casp_study=$casp_study processes=$processes forward_expansion=${forward_expansions[1]} retro_expansion=${retro_expansions[1]}